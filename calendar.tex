...
\begin{tikzpicture}[thick]
  ...
  %     equals=2017-02-24, % Midsommar
  %     equals=2017-11-04, % Alla helgons dag
  %     equals=12-25, % Juldagen
  %     equals=12-26 %Annandag Jul
  %     ) [red]
  % if(equals=01-01) [Nyårsdagen]
  % if(equals=2017-01-06) [Trettondagen]
  % if(Easter=-2) [Långfredag]
  % if(Easter=1) [ Annandag påsk]
  % if(equals=05-01) [Första maj]
  % if(Easter=39) [Kristihimmelfärd]
  % if(Easter=49) [Pingst]
  % if(equals=06-06) [Flaggdagen]
  % if(equals=2017-02-24) [Midsommar]
  % if(equals=2017-11-04) [Alla helgons dag]
  % if(equals=12-25) [Juldagen]
  % if(equals=12-26) [Annandag Jul]
