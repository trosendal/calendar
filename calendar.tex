...
\begin{tikzpicture}[thick]
  ...
  if (equals=01-01) [observance=Förste nyttårsdag]
  ...
  if (equals=05-01) [observance=Offentlig hytidsdag]
  if (equals=05-08) [observance=Frigringsdagen]
  if (equals=05-17) [observance=Grunnlovsdag]
  if (equals=06-07) [observance=UnionsopplÃ¸sningen]
  ...
  if (equals=12-25) [observance=FÃ¸rste juledag]
  if (equals=12-26) [observance=Andre juledag]
  if (Easter=-49) [observance=Fastelavnssöndag]
  if (Easter=-7) [observance=Palmesöndag]
  if (Easter=-3) [observance=Skjärtorsdag]
  if (Easter=-2) [observance=Langfredag]
  if (Easter) [observance=Förste påskedag]
  if (Easter=1) [observance=Andre påskedag]
  if (Easter=39) [observance=Kristi himmelfartsdag]
  if (Easter=49) [observance=Förste pinsedag]
